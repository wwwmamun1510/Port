        ...
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="text-center">Add Service Information</h4>
                  </div>
                <div class="card-body">
...
<div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-center">Service Policey Information</h4>
                </div>
                <div class="card-body">
                 <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$loop->index+1}}</td>
                                <td>
                                    <img src="{{ asset('public/uploads/services/'.$item->service_image)}}" width="70px" height="70px" alt="Service Image">
                                </td>
                                <td>{{$item->title }}</td>
